...
fn main() {
    ...
    // mmu.print_user_memory();
    test.add_program("Simple_program".to_string(), true);
    test.add_program("Simple_program2".to_string(), false);
    test.add_program("Simple_program3".to_string(), false);
    // test.add_program("Simple_program4".to_string() false);
    test.add_program("Simple_program5".to_string(), false);
